...
<div class="d-flex min-vh-100">
    ...
    <div class="d-flex flex-column flex-shrink-0 p-3 bg-primary text-white" style="width: 280px;">
        ...
        <ul class="nav nav-pills flex-column mb-auto">
            <li class="nav-item">
                <a href="{{ route('dashboard') }}" class="nav-link active bg-light text-dark" aria-current="page">Dashboard</a>
            </li>
            <li>
                ...
                <div class="col-md-4">
                    <div class="card h-100">
                        <div class="card-body">
                            ...
                            <p class="card-text display-6 text-primary">{{ $totalStudents }}</p>
                ...
                <div class="col-md-4">
                    <div class="card h-100">
                        <div class="card-body">
                            ...
                            <p class="card-text display-6 text-primary">{{ $activeClasses }}</p>
                ...
                <div class="col-md-4">
                    <div class="card h-100">
                        <div class="card-body">
                            ...
                            <p class="card-text display-6 text-danger">{{ $attendanceAlerts }}</p>
